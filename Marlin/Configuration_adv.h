 ...
 */
  ...
  #define MESH_MIN_Y (MESH_INSET) // (67)
  #define MESH_MAX_X (X_BED_SIZE - MESH_INSET) // (X_BED_SIZE - 45)
  #define MESH_MAX_Y (Y_BED_SIZE - MESH_INSET) // (Y_BED_SIZE - 5)
#endif
 ...
 */
  ...
  #define INTERPOLATE      true
  ...
  #if AXIS_IS_TMC_CONFIG(X)            // @@@ X motor current
    ...
    #define Y_CURRENT       1000 // @@@ Y motor current
    ...
    #define Z_CURRENT       1000 // @@@ Z motor current, increase - two motors
   ...
   */
  #define SENSORLESS_HOMING // StallGuard capable drivers only // @@@ NO END STOPS!!!
