 ...
 */
  ...
  #define WATCH_TEMP_INCREASE 2               // Degrees Celsius // @ 4 - in original
#endif
 ...
 */
//#define HOTEND_IDLE_TIMEOUT // @ enabled - in original
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // @ PB0 - in original
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  30, 30 }, { 190,  30 }, { 190, 180 }, { 30, 180 } }
...
// LCD Print Progress options
   ...
   * point in the file.
   */
  //#define POWER_LOSS_RECOVERY // @ enabled - in original
 ...
 */
#define BABYSTEPPING // @ enabled - in original
 ...
 */
//#define ADVANCED_PAUSE_FEATURE // @ enabled - in original
 ...
 */
   ...
   */
  //#define HYBRID_THRESHOLD // @@@ пока выключил
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only @@@ NO ENDSTOPS!
    ...
    #define X_STALL_SENSITIVITY  10                   // M914 X10 Y10  ; Set X and Y stall sensitivity to 10
...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC "Temp ==> " PREHEAT_1_LABEL                                                           // "Home & UBL Info"
  ...
  #define MAIN_MENU_ITEM_2_DESC "Temp ==> " PREHEAT_2_LABEL
  #define MAIN_MENU_ITEM_2_GCODE "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND)
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Temp ==> PET-G"
  #define MAIN_MENU_ITEM_3_GCODE "M140 S75\nM104 S240"
  //#define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Heat Bed(" PREHEAT_1_LABEL ")/Home/Level"
